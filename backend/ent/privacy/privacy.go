...
// EvalQuery return f(ctx, q).
func (f SpecialistQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SpecialistQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.SpecialistQuery", q)
}

// The SpecialistMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type SpecialistMutationRuleFunc func(context.Context, *ent.SpecialistMutation) error

// EvalMutation calls f(ctx, m).
func (f SpecialistMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.SpecialistMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.SpecialistMutation", m)
}

// The WorkingQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type WorkingQueryRuleFunc func(context.Context, *ent.WorkingQuery) error

// EvalQuery return f(ctx, q).
func (f WorkingQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.WorkingQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.WorkingQuery", q)
}

// The WorkingMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type WorkingMutationRuleFunc func(context.Context, *ent.WorkingMutation) error

// EvalMutation calls f(ctx, m).
func (f WorkingMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.WorkingMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.WorkingMutation", m)
}
